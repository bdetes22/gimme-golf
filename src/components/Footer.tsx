...
const playLinks = [
  ...
  { href: "/book", label: "Memberships" },
  { href: "/book", label: "Punch Passes" },
  { href: "/contact", label: "Events & Parties" },
];
        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <img
              ...
              className="mb-4"
            />
            <p className="max-w-xs text-sm leading-relaxed text-[#F0E8D2]/50">
          ...
          <div>
            <h4
              className="mb-4 text-sm font-bold uppercase tracking-[0.2em] text-[#F0E8D2]"
              style={{ fontFamily: "var(--font-barlow-condensed)" }}
            >
              Play
            </h4>
            <ul className="flex flex-col gap-3">
              {playLinks.map((link, i) => (
                <li key={`${link.href}-${i}`}>
                  <Link
                    href={link.href}
