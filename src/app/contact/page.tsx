        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-6">
            <div className="rounded-lg border border-[#F0E8D2]/10 bg-[#F0E8D2]/[0.03] p-6">
              <h3 className="mb-3 text-lg font-semibold text-[#F0E8D2]" style={{ fontFamily: "var(--font-barlow-condensed)" }}>Email</h3>
            ...
            <div className="rounded-lg border border-[#F0E8D2]/10 bg-[#F0E8D2]/[0.03] p-6">
              ...
              <div className="flex gap-4">
                <a href="#" aria-label="Instagram" className="flex h-9 w-9 items-center justify-center rounded-full border border-[#F0E8D2]/10 text-[#F0E8D2]/40 transition-colors hover:border-[#2D6A47]/40 hover:text-[#2D6A47]">
                ...
                <a href="#" aria-label="Facebook" className="flex h-9 w-9 items-center justify-center rounded-full border border-[#F0E8D2]/10 text-[#F0E8D2]/40 transition-colors hover:border-[#2D6A47]/40 hover:text-[#2D6A47]">
                  <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
